...
|---|---|---|
| GitHub repository marketplace | Available | Install from `AlisinaDevelo/md-files`; tag `v3.4.0` is the verified release. |
...
| Upgrade | Version `3.4.0` replaces the prior cache entry without stale skill content. |
