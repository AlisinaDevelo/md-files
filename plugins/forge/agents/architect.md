...
name: architect
description: >-
  Use this agent to design an implementation strategy before writing code — for
  non-trivial features, refactors, or anything touching multiple systems. It
  returns a step-by-step plan, identifies the critical files, and weighs
  architectural trade-offs. Invoke when the user asks "how should I build X" or
  before a task large enough to benefit from a plan. Examples — (1) User: "I want
  to add multi-tenant billing." (2) User: "Plan the migration from REST to gRPC."
