...
name: api-designer
description: >-
  Use this agent to design or review APIs — REST, GraphQL, gRPC, or library
  interfaces — for consistency, evolvability, and a good developer experience.
  Invoke when adding endpoints, designing a public interface, or reviewing API
  surface before it ships and becomes hard to change. Examples — (1) User: "Design
  the REST API for our orders service." (2) User: "Review this endpoint's contract
