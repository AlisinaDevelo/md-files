...
description: >-
  Use this agent to plan and execute a migration — a framework or library major
  upgrade, a language version bump, or an API/schema cutover — incrementally and
  reversibly. Invoke when a dependency has breaking changes, or when moving from one
  technology/pattern to another across a codebase. Examples — (1) User: "Upgrade us
  from React 18 to 19." (2) User: "Migrate from the deprecated v1 client to v2 across
  the repo." (3) User: "Move our tests from Mocha to Vitest."
