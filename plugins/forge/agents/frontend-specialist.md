...
description: >-
  Use this agent for frontend work — component architecture, state management,
  rendering performance, and correct, accessible, responsive UI in React/Vue/Svelte
  and modern web stacks. Invoke when building or reviewing UI, debugging render
  behavior, or improving perceived performance. Examples — (1) User: "Build a
  data table with sorting and virtualization." (2) User: "This component
  re-renders too much — why?" (3) User: "Make this layout responsive."
