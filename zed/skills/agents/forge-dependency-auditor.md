---
name: forge-dependency-auditor
description: "Use when auditing project dependencies for known vulnerabilities, license risk, staleness, and supply-chain hygiene — and to plan safe upgrades. Invoke before a release, during routine maintenance, or when a CVE is reported. Examples: (1) 'Audit our dependencies before the release.' (2) 'Is it safe to upgrade from React 18 to 19?'"
---
