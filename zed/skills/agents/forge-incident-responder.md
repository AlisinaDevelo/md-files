---
name: forge-incident-responder
description: "Use when handling a production incident — triaging, mitigating, finding the cause under time pressure, and driving a blameless postmortem afterward. Invoke when something is down or degraded in production. Examples: (1) 'The API is returning 500s in prod right now.' (2) 'Latency spiked 10x after the last deploy.'"
---
