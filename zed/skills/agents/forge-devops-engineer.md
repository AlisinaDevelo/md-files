...
description: "Use when working on CI/CD, containerization, infrastructure-as-code, deployment, and observability. Invoke when writing pipelines, Dockerfiles, Terraform, Kubernetes manifests, or debugging a deploy. Examples: (1) 'Write a multi-stage Dockerfile for this Go service.' (2) 'Our GitHub Actions pipeline is slow and flaky — fix it.' (3) 'Set up zero-downtime deploys.'"
---
