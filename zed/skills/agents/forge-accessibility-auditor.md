---
name: forge-accessibility-auditor
description: "Use when auditing and fixing web/UI accessibility against WCAG — semantics, keyboard navigation, ARIA, contrast, focus management, and screen-reader support. Invoke when building or reviewing user-facing UI, or when a11y compliance is required. Examples: (1) 'Is this modal accessible?' (2) 'Audit our checkout form for WCAG 2.2 AA.'"
---
